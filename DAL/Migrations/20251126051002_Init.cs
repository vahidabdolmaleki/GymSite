    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnitCities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UnitCities_UnitCities_UnitCityId",
                        column: x => x.UnitCityId,
                        principalTable: "UnitCities",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AddressDetails_UnitCities_CityId",
                        column: x => x.CityId,
                        principalTable: "UnitCities",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AddressDetails_UnitCities_UnitId",
                        column: x => x.UnitId,
                        principalTable: "UnitCities",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkoutSubCategories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkoutSubCategories_WorkoutCategories_WorkoutCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PushNotificationId = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DietPlans_People_PersonId",
                        column: x => x.PersonId,
                        principalTable: "People",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Addresses_AddressDetails_AddressDetailId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WorkoutCategoryId = table.Column<int>(type: "int", nullable: false),
                    WorkoutSubCategoryId = table.Column<int>(type: "int", nullable: true),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    PrimaryMuscleGroup = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.WorkoutSubCategoryId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkoutLogs_People_PersonId",
                        column: x => x.PersonId,
                        principalTable: "People",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkoutMedias", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkoutMedias_Workouts_WorkoutId",
                        column: x => x.WorkoutId,
                        principalTable: "Workouts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "مدیر سیستم", true, "Admin" },
                    { 2, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "کاربر سیستم", true, "User" },
                    { 3, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "مربی باشگاه", true, "Coach" },
                    { 4, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "حسابدار", true, "Accountant" },
                    { 5, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "ورزشکار یا کاربر معمولی", true, "Athlete" },
                    { 6, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "ورزشکار حرفه ای یا کاربر VIP", true, "ProfessionalAthlete" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AddressDetails_UnitId",
                table: "AddressDetails",
                column: "UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_Addresses_AddressDetailId",
                table: "Addresses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkoutMedias_WorkoutId",
                table: "WorkoutMedias",
                column: "WorkoutId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Workouts_WorkoutSubCategoryId",
                table: "Workouts",
                column: "WorkoutSubCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkoutSubCategories_WorkoutCategoryId",
